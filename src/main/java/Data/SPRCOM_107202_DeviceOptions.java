...
public class SPRCOM_107202_DeviceOptions {
    ...
    public Object[][] getData() {
        Object[][] deviceOption = {
                {"Phones", "Apple", "Apple iPhone XS", "Sprint Flex 18-mo. lease", "Unlimited Savings Plan", "Add protection"},
...
//
                {"Tablets", "Apple", "Apple iPad (6th generation)", "Buy it at full price", "Unlimited Savings Plan", "Add protection"},
...
//                {"Tablets", "Apple", "Apple iPad mini 4", "Buy it at full price", "Unlimited Savings Plan", "Add protection"}
                ...
                {"Watches", "Apple", "Apple Watch 4", "Buy it at full price", "Unlimited Savings Plan", "Add protection"},

                {"Others", "Sprint", "Sprint Drive", "Buy it with 24 monthly installments", "Sprint Drive Wifi 2GB Plan", "Add protection"},
